...
class new:
    ...
    def create_new_from_template(self, access_token, template_thread_id, member_ids):
        ...
        new_html = template_html.replace("Feedback For Engineers Template", "Feedback For Lindsey From Kurchi")
    ...
    def POST(self):
        ...
        new_document_response = self.create_new_from_template(access_token, template_thread_id)

        web.header('Content-Type', 'application/json')
        return json.dumps({'message': "POST OK!", 'api_response': new_document_response})
